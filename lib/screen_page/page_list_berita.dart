...
import 'package:salsabilaagustinpy_2201092054/screen_page/page_detail_berita.dart';
import 'package:salsabilaagustinpy_2201092054/screen_page/page_loginAPI.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http.get(
        Uri.parse("http://192.168.9.194/uts_mobile/berita.php"),
      );
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network('http://192.168.9.194/uts_mobile/image/${data.gambar}',
                                        fit: BoxFit.fill,
                                      ),
                                    )
                                ),
